...
exports.isAdminOrtheRegisterUser = void 0;
const error_1 = require("../../error/error");
const auth_service_1 = __importDefault(require("../../service/auth-service"));
const isAdmin_1 = require("./isAdmin");
const isAdminOrtheRegisterUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!token) {
        ...
        if (tokenType instanceof error_1.myError) {
            ...
            const theUser = yield auth_service_1.default.findUserById(id);
...
exports.isAdminOrtheRegisterUser = isAdminOrtheRegisterUser;
